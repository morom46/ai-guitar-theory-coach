    ...
    <div className="page">
      ...
      <Chapter id="ch1" level="Level 1 · the raw material" title="A NOTE IS A SPEED" ghost="01">
        ...
        <P delay={120}>
          ...
          exactly half its length, so it vibrates exactly twice as fast, at 220 Hz. And here's the strange part your ear
      ...
      <Chapter id="ch3" level="Level 3 · distances" title="INTERVALS: THE FEELING OF A GAP" ghost="03">
        ...
        <P delay={120}>
          ...
          distortion, which multiplies sounds together and punishes any friction, it is practically the only
          interval left standing. That's the <b>power chord</b>, and it's why metal is built from 5ths. At the exact opposite pole
